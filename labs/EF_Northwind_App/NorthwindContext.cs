...
namespace EF_Northwind_App
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<FrenchCustomers> FrenchCustomers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FrenchCustomers>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("French_customers");
            ...
            {
                entity.HasKey(e => e.SpartanId)
                    .HasName("PK__Spartans__F479D1FEAA4D92CB");

                entity.Property(e => e.SpartanId).HasColumnName("Spartan_ID");
                ...
                entity.Property(e => e.MarkAcheived)
                    .HasMaxLength(5)
                    .IsUnicode(false);
